...
@Component({
  selector: 'app-genome-browser-summary-resizable',
  templateUrl: './genome-browser-summary-resizable.component.html',
  styleUrls: ['./genome-browser-summary-resizable.component.css'],
})
export class GenomeBrowserSummaryResizableComponent implements AfterContentInit, OnDestroy {
  width: number;
  loading = true;
  error = '';
