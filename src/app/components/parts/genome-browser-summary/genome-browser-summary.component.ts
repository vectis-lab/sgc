...
@Component({
  selector: 'app-genome-browser-summary',
  templateUrl: './genome-browser-summary.component.html',
  styleUrls: ['./genome-browser-summary.component.css'],
  providers: [TranscriptTrackService]
})
export class GenomeBrowserSummaryComponent implements AfterViewInit, OnDestroy {
    @Input() width: number;
    genomeBrowser: any;
    ...
    constructor(private searchService: VariantSummarySearchService,
                private variantTrackService: VariantSummaryTrackService,
