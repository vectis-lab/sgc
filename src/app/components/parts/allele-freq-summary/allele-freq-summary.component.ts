...
@Component({
    selector: 'app-allele-freq-summary',
    templateUrl: './allele-freq-summary.component.html',
    styleUrls: ['./allele-freq-summary.component.css']
})

export class AlleleFreqSummaryComponent implements OnInit {
    @Input() freq: number;
