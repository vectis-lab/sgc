...
export class CohortInformationComponent implements AfterViewInit, OnDestroy, OnInit {
    ...
    loadCharts(){
        ...
        this.charts = this.clinicalFields.map(field => {
          ...
          return new Chart(field.name, field.label, field.chartType, dim, field.width, field.height, field.visible, group, null, field.filterHandler, "", "", field.start, field.end)
        })
